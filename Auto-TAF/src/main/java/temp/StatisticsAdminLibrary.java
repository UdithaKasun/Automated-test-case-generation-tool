...
//	private StatisticData getWebappRelatedData;
	...
	public long getMinOperationResponseTime(String serviceName,String operationName)  throws Exception{
	...
	public int getOperationRequestCount(String serviceName,String operationName)  throws Exception{
	...
	public ServiceStatistics getServiceStatistics(String serviceName)  throws Exception{
	...
	public int getServiceFaultCount(String serviceName)  throws Exception{
...
//	}
//	public StatisticData getWebappRelatedData(String webAppName)  throws Exception{
...
//	}
	...
	public long getMaxOperationResponseTime(String serviceName,String operationName)  throws Exception{
	...
	public double getAvgOperationResponseTime(String serviceName,String operationName)  throws Exception{
	...
	public int getServiceResponseCount(String serviceName)  throws Exception{
	...
	public OperationStatistics getOperationStatistics(String serviceName,String operationName)  throws Exception{
		this.getOperationStatistics= stub.getOperationStatistics(serviceName,operationName);
		return this.getOperationStatistics;
	}
	public void setConfigurationContext(ConfigurationContext configurationContext)  throws Exception{
	...
	public int getServiceRequestCount(String serviceName)  throws Exception{
	...
	public int getOperationResponseCount(String serviceName,String operationName)  throws Exception{
	...
	public int getOperationFaultCount(String serviceName,String operationName)  throws Exception{
