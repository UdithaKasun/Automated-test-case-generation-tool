...
//			.getLog(SecureAxisServiceClient.class);
//
//	/**
...
//	 * @throws Exception
//	 */
//	public OMElement sendReceive(String userName, String password,
//			String endpointReference, String operation, OMElement payload,
//			int securityScenarioNo) throws Exception {
//		if (securityScenarioNo == 1) {
//			Assert.assertTrue(endpointReference.startsWith("https:"),
//					"Endpoint reference should be https");
//		}
//		AutomationContext autoContext = new AutomationContext();
//		String keyPath = FrameworkPathUtil.getSystemResourceLocation()
//				+ File.separator
//				+ autoContext
//						.getConfigurationValue("//keystore/fileName/text()");
//		String securityPolicyPath = FrameworkPathUtil
...
//		ServiceClient sc = getServiceClient(userName, password,
//				endpointReference, operation, securityPolicyPath, "wso2carbon",
//				"wso2carbon", keyPath, "wso2carbon");
//		OMElement result;
...
//			String encryptionUser, String keyStorePath, String keyStorePassword)
//			throws Exception {
//		ServiceClient sc = getServiceClient(userName, password,
//				endpointReference, operation, securityPolicyPath,
...
//	 * @throws Exception
//	 */
//	public void sendRobust(String userName, String password,
//			String endpointReference, String operation, OMElement payload,
//			int securityScenarioNo) throws Exception {
//		if (securityScenarioNo == 1) {
//			Assert.assertTrue(endpointReference.startsWith("https:"),
...
//	}
//
//	private Policy loadPolicy(String userName, String securityPolicyPath,
//			String keyStorePath, String keyStorePassword, String userCertAlias,
//			String encryptionUser) throws Exception {
//		Policy policy = null;
...
//			prop1.put("org.apache.ws.security.crypto.merlin.keystore.type",
//					"JKS");
...
//		try {
//			sc = new ServiceClient(ConfigurationContextProvider.getInstance()
...
//						loadPolicy(userName, securityPolicyPath, keyStorePath,
//								keyStorePassword, userCertAlias, encryptionUser));
//			} catch (Exception e) {
//				log.error(e);
